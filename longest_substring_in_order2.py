...
Template for task: find the longest substring in the alphabetic order of given string
Author: Mikko Saari mikko.l.saari@tuni.fi H245759
"""
def longest_substring_in_order(word):
<<<<<<< HEAD
=======
<<<<<<< HEAD
>>>>>>> 8c7edb52d4a2a7858a9b5fb4aa01f9a34dac3ba4
    """
